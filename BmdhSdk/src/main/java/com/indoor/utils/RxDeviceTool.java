...
public class RxDeviceTool {
    private static final String TAG = RxDeviceTool.class.getSimpleName();
    ...
    public static String getDeviceId(Context context) {
        if(!TextUtils.isEmpty(getSPUUID(context))){
        ...
        try {
            ...
            if(!TextUtils.isEmpty(imei)){
                ...
                saveSPUUID(context,deviceId.toString());
    ...
    public static String getSPUUID(Context context){
        SharedPreferences mShare = context.getSharedPreferences("azimuthCacheMap", Context.MODE_PRIVATE);
        if(mShare == null){
            KLog.e(TAG, "getSPUUID : null" );
            return null;
        }
        KLog.e(TAG, "getSPUUID : " + mShare.getString("uuid", ""));
        return mShare.getString("uuid", "");
    }

    public static void saveSPUUID(Context context,String uuid){
        SharedPreferences mShare = context.getSharedPreferences("azimuthCacheMap", Context.MODE_PRIVATE);
        if(mShare == null){
            KLog.e(TAG, "saveSPUUID : null" );
            return;
        }
        KLog.e(TAG, "saveSPUUID : " +uuid);
    ...
    public static String getUUID(Context context){
        String uuid="";
        SharedPreferences mShare = context.getSharedPreferences("azimuthCacheMap", Context.MODE_PRIVATE);
        uuid = getSPUUID(context);
        if(TextUtils.isEmpty(uuid)){
            uuid = UUID.randomUUID().toString();
        }

        KLog.e(TAG, "getUUID : " + uuid);
        return uuid;
    }
    ...
    private static void toastError(Context context, String errMsg) {
        KLog.e(TAG, errMsg);
...
//        TelephonyManager tm = (TelephonyManager) context.getSystemService(Context.TELEPHONY_SERVICE);
//        if (ActivityCompat.checkSelfPermission(context, Manifest.permission.READ_PHONE_STATE) != PackageManager.PERMISSION_GRANTED) {
//            toastError(context,"请先获取读取手机设备信息权限");
//            return null;
//        }
...
//    }
    ...
    public static String getBuildMANUFACTURER() {
        return Build.MANUFACTURER+"_"+getBuildBrandModel();// samsung 品牌
    }
